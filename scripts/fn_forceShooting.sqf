 ...
 *
 * Example:
 * [shooter, target] call TAC_Scripts_fnc_forceShooting;
 * [shooter, target, 20] call TAC_Scripts_fnc_forceShooting;
 * [shooter, target, 30, 0.5] call TAC_Scripts_fnc_forceShooting;
*/
